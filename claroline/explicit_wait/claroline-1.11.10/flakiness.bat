...
for /L %%i in (1,1,%n%) do (
    ...
    echo Saving results...
    mkdir "..\..\..\..\flakycheck\claroline\selenium4-nosleep-chrome127native-2\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\claroline\selenium4-nosleep-chrome127native-2\%%i\"
