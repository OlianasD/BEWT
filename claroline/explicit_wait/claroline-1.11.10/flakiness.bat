...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\claroline\selenium4-nosleep-chrome127docker\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\claroline\selenium4-nosleep-chrome127docker\%%i\"
