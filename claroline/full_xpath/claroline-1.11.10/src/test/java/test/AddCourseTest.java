...
public class AddCourseTest extends BaseTest {
	...
	public void testClarolineAddCourse() throws Exception {
		...
		selectArrow.click();
		WebElement registrationRadio = driver.findElement(By.xpath("/html/body/div/div[2]/form/fieldset[1]/div/dl/dd[8]/input[1]"));
		registrationRadio.click();
		...
		assertTrue(successMsg.getText().contains("You have just created the course website : 001"));
