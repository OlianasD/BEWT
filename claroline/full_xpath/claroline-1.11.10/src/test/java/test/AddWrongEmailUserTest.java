...
public class AddWrongEmailUserTest extends BaseTest {
	...
	public void testClarolineAddWrongEmailUser() throws Exception {
		...
		passwordConfField.sendKeys("0v3rtlyC0mpl1c4t3dPsW");
		WebElement emailField = driver.findElement(By.xpath("/html/body/div/div[2]/form/fieldset[3]/dl/dd[1]/input"));
		...
		assertTrue(errorMsg.getText().contains("The email address is not valid"));
