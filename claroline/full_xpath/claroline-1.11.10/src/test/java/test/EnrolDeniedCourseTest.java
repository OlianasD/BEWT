...
public class EnrolDeniedCourseTest extends BaseTest {
	...
	public void testClarolineEnrolDeniedCourse() throws Exception {
		...
		courseSearchBox.sendKeys("Course003");
		...
		enrolIcon.click();
		WebElement errorMsg = driver.findElement(By.xpath("/html/body/div/div[2]/div[1]/div[1]"));
		assertTrue(errorMsg.getText().contains("This course currently does not allow new enrolments (registration: close)"));
