...
public class AddPasswordCourseTest extends BaseTest {
	...
	public void testClarolineAddPasswordCourse() throws Exception {
		...
		selectArrow.click();
		WebElement publicAccessRadio = driver.findElement(By.xpath("/html/body/div/div[2]/form/fieldset[1]/div/dl/dd[7]/input[1]"));
		publicAccessRadio.click();
		WebElement enrolmentKeyCheckbox = driver.findElement(By.xpath("/html/body/div/div[2]/form/fieldset[1]/div/dl/dd[8]/blockquote/input[2]"));
		enrolmentKeyCheckbox.click();
		WebElement enrolmentKeyField = driver.findElement(By.xpath("/html/body/div/div[2]/form/fieldset[1]/div/dl/dd[8]/blockquote/input[3]"));
		enrolmentKeyField.sendKeys("n0tl34k3dy3t");
		...
		assertTrue(successMsg.getText().contains("You have just created the course website : 002"));
