...
public class SearchTeacherTest extends BaseTest {
	...
	public void testClarolineSearchTeacher() throws Exception {
		...
		assertTrue(displayedUser.getText().contains("testuser2"));
