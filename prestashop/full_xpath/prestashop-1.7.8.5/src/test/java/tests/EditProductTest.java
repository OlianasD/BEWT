...
public class EditProductTest extends BaseTest {
	...
	public void test_edit_product() throws InterruptedException {
		...
		products.click();
		WebElement editFirstProduct = driver.findElement(By.xpath("/html/body/div[2]/div/div[1]/div/div[2]/div/form/div[2]/div/div/table/tbody/tr[1]/td[11]/div/div/a"));
		editFirstProduct.click();
		Thread.sleep(2000);
		WebElement productName = driver.findElement(By.xpath("/html/body/div[1]/div/div/div/form/div[1]/div/div/div[1]/div[1]/div/div/div[1]/input"));
		productName.clear();
		productName.sendKeys("Deep Blue Jacket");
		WebElement saveBtn = driver.findElement(By.xpath("/html/body/div[1]/div/div/div/form/div[4]/div[2]/input"));
		saveBtn.click();
		Thread.sleep(1000);
		WebElement goToCatalog = driver.findElement(By.xpath("/html/body/div[1]/div/div/div/form/div[4]/div[2]/button[2]"));
		goToCatalog.click();
		WebElement displayedProduct = driver.findElement(By.xpath("/html/body/div[2]/div/div[1]/div/div[2]/div/form/div[2]/div/div/table/tbody/tr[1]/td[4]/a"));

		assertEquals("Deep Blue Jacket",
				displayedProduct.getText());
