...
public class AddNewProductTest extends BaseTest {
	...
	@Test
	public void test_add_new_productNoPO() throws InterruptedException{
		...
		newProduct.click();
		Thread.sleep(2000);
		WebElement prodName = driver.findElement(By.xpath("/html/body/div[1]/div/div/div/form/div[1]/div/div/div[1]/div[1]/div/div/div[1]/input"));
		prodName.clear();
		prodName.sendKeys("Blue Jacket3");
		...
		assertEquals("Blue Jacket3", displayedProduct.getText());
	}
