...
public class AddNewProductWithTax10Test extends BaseTest {
	
	@Test
	public void test_add_new_product_with_tax10() throws InterruptedException{
		...
		taxRuleInput.sendKeys("IT Reduced Rate (10%)");
		...
		assertEquals("€11.00", finalPrice.getText());
	}
}
