...
public class AddNewAttributeTest extends BaseTest {
	...
	public void test_add_attributes() throws InterruptedException {
		...
		name.sendKeys("Quantity");
		WebElement publicName = driver.findElement(By.xpath("/html/body/div[1]/div/div[5]/div/form/div/div[2]/div[2]/div/div/div[1]/div[1]/input"));
		publicName.sendKeys("Qnt");
