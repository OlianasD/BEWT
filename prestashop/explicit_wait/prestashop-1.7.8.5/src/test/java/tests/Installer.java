...
public class Installer {
	...
	public void install() throws InterruptedException {
		...
		boolean success = new WebDriverWait(driver, Duration.ofSeconds(120)).until(ExpectedConditions.textToBe(By.xpath("//*[@id=\"install_process_success\"]/div/h2"), "Your installation is finished!"));
		if(success) {
