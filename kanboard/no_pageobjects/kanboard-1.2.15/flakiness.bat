...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\kanboard\java21-selenium435-chrome140-headlessnew\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\kanboard\java21-selenium435-chrome140-headlessnew\%%i\"
