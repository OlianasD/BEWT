...
public class AddLocalUser_ShortPassword_Test extends BaseTest {
	...
	public void addShortPassword() {
		...
		passwordConfField.sendKeys("test");
		WebElement saveBtn = driver.findElement(By.xpath("/html/body/div/div/div[2]/form/div[2]/div/button"));
		saveBtn.click();
		WebElement shortPswErrorMsg = driver.findElement(By.xpath("/html/body/div/div/div[2]/form/div[1]/div[1]/fieldset[2]/ul[1]"));
		
		assertEquals("The minimum length is 6 characters", shortPswErrorMsg.getText());
