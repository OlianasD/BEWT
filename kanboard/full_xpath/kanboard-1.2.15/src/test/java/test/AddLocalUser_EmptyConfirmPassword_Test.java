...
public class AddLocalUser_EmptyConfirmPassword_Test extends BaseTest {
	...
	public void addEmptyConfirmation() {
		...
		saveBtn.click();
		WebElement pswConfErrorMsg = driver.findElement(By.xpath("/html/body/div/div/div[2]/form/div[1]/div[1]/fieldset[2]/ul[2]/li"));
		
		assertEquals("The confirmation is required", pswConfErrorMsg.getText());
