...
public class AddLocalUser_EmptyUsername_Test extends BaseTest {
	...
	public void addEmptyUser() {
		...
		saveBtn.click();
		WebElement usernameErrorMsg = driver.findElement(By.xpath("/html/body/div/div/div[2]/form/div[1]/div[1]/fieldset[1]/ul"));
		
		assertEquals("The username is required", usernameErrorMsg.getText());
