...
public class DisableUser_Test extends BaseTest {
	
	@Test
	public void disableUser_Test() throws InterruptedException {
		...
		securityTab.click();
		WebElement disableUser = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/form/div[2]/div[3]/div[4]/div[2]/button[1]"));
		disableUser.click();
		Thread.sleep(500);
		WebElement userStatus = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/table/tbody/tr[2]/td[4]"));
		
		assertEquals("Disabled", userStatus.getText());
	}
}
