...
public class ChangePostDate_Test extends BaseTest {

	@Test
	public void changePostDate_Test()  throws InterruptedException {
		...
		contentLink.click();
		WebElement editPost = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div[1]/div[1]/table/tbody/tr[1]/td[3]/a[2]"));
		editPost.click();
		...
		Thread.sleep(500);
		WebElement dateElem = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/form/div[2]/div/div[2]/div[1]/input"));
		dateElem.clear();
		dateElem.sendKeys("2022-08-03 14:42:26");
		...
		WebElement secondAdvancedTab =	driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/form/div[2]/nav/div/a[2]"));
		secondAdvancedTab.click();
		WebElement secondDateElem = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/form/div[2]/div/div[2]/div[1]/input"));


		assertEquals("2022-08-03 14:42:26", secondDateElem.getAttribute("value"));
