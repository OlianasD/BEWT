...
public class AddDiscountCodeAmountTest extends BaseTest {
	...
	public void testExpressCartAddDiscountCodeAmount() throws Exception {
		...
		Thread.sleep(1000);
		WebElement displayedDiscountCode = driver.findElement(By.xpath("/html/body/div[2]/div/main/div/ul/li[5]/div/div[1]/span"));

		assertEquals("Code:  discount000", displayedDiscountCode.getText());
	}
