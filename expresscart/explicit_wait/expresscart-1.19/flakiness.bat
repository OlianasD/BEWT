...
for /L %%i in (1,1,%n%) do (
    ...
    mkdir "..\..\..\..\flakycheck\expresscart\java21-selenium435-chrome127docker-3-noheadless\%%i"
    xcopy /E /Y "target\surefire-reports\*" "..\..\..\..\flakycheck\expresscart\java21-selenium435-chrome127docker-3-noheadless\%%i\"
