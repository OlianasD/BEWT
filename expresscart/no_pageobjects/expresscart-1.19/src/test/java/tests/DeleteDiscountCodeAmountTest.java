...
public class DeleteDiscountCodeAmountTest extends BaseTest {
	...
	public void testExpressCartDeleteDiscountCodeAmount() throws Exception {
		...
		WebElement codeElem = driver.findElement(By.xpath("//*[contains(text(), 'discount000')]"));
		...
		assertFalse(driver.findElement(By.xpath("//*[@id=\"container\"]/div/main/div/ul")).getText().contains("Code:  discount000"));
	}
