...
public class UpdateProjectDescriptionTest extends BaseTest {
	...
	public void updateProjectDescription() throws InterruptedException {
		...
		projectLink.click();
		WebElement descrField = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div[2]/form/div/div[2]/div/div/table/tbody/tr[6]/td[2]/textarea"));
		descrField.clear();
		...
		assertEquals(descr, displayedDescr.getText());
