...
public class UpdateIssueStatusConfirmedTest extends BaseTest {
	...
	@Test
	public void updateIssueStatusConfirmed() throws InterruptedException{
		...
		new Select(selectStatus).selectByVisibleText(Strings.statusConfirmed);
		...
		assertEquals(Strings.statusConfirmed, displayedStatus.getText());
