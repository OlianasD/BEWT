...
public class UpdateProjectStatusTest extends BaseTest {
	...
	@Test
	public void updateProjectStatus() throws InterruptedException {
		...
		projectLink.click();
		WebElement projectStatusSelect = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div[2]/form/div/div[2]/div/div/table/tbody/tr[2]/td[2]/select"));
		new Select(projectStatusSelect).selectByVisibleText(Strings.projectStatusStable);
		...
		assertEquals(Strings.projectStatusStable, displayedStatus.getText());
