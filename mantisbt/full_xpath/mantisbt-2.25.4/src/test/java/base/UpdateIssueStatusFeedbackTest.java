...
public class UpdateIssueStatusFeedbackTest extends BaseTest {
	...
	@Test
	public void updateIssueStatusFeedback() throws InterruptedException{
		...
		new Select(selectStatus).selectByVisibleText(Strings.statusFeedback);
		...
		assertEquals(Strings.statusFeedback, displayedStatus.getText());
