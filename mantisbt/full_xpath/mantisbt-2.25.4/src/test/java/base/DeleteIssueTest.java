...
public class DeleteIssueTest extends BaseTest {
	...
	public void deleteIssue() throws InterruptedException {
		...
		new Select(actionSelect).selectByVisibleText(Strings.delete);
		...
		okBtn.click();
		WebElement deleteIssuesBtn = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div/form/div/div[2]/div[2]/input"));
		deleteIssuesBtn.click();
		WebElement issuesEmpty = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[2]/form/div/div[1]/h4"));
		
		assertEquals(Strings.anomaliesEmpty, issuesEmpty.getText());
