...
public class UpdateIssueSeverityTest extends BaseTest {
	...
	@Test
	public void updateIssueSeverity() throws InterruptedException {
		...
		editIssue.click();
		WebElement severitySelect = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/form/div/div[2]/div/div/table/tbody/tr[6]/td[2]/select"));
		new Select(severitySelect).selectByVisibleText(Strings.majorSeverity);
		WebElement saveBtn = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/form/div/div[3]/input"));
		saveBtn.click();
		Thread.sleep(500);
		WebElement displayedSeverity = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/table/tbody/tr[6]/td[2]"));

		assertEquals(Strings.majorSeverity, displayedSeverity.getText());
