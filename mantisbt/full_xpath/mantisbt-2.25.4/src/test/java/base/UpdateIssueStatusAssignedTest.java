...
public class UpdateIssueStatusAssignedTest extends BaseTest {
	...
	@Test
	public void updateIssueStatusAssigned() throws InterruptedException{
		...
		new Select(selectStatus).selectByVisibleText(Strings.statusAssigned);
		...
		assertEquals(Strings.statusAssigned, displayedStatus.getText());
