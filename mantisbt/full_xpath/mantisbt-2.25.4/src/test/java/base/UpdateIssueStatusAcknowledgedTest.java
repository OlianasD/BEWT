...
public class UpdateIssueStatusAcknowledgedTest extends BaseTest {
	...
	@Test
	public void updateIssueStatusAcknowledged() throws InterruptedException{
		...
		new Select(selectStatus).selectByVisibleText(Strings.statusAcknowledged);
		...
		assertEquals(Strings.statusAcknowledged, displayedStatus.getText());
