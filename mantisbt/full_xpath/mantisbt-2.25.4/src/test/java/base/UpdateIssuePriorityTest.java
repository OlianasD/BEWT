...
public class UpdateIssuePriorityTest extends BaseTest {
	...
	@Test
	public void updateIssuePriority() throws InterruptedException {
		...
		editIssue.click();
		WebElement prioritySelect = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/form/div/div[2]/div/div/table/tbody/tr[6]/td[1]/select"));
		new Select(prioritySelect).selectByVisibleText(Strings.priorityLow);
		WebElement saveBtn = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/form/div/div[3]/input"));
		saveBtn.click();
		Thread.sleep(500);
		WebElement displayedPriority = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/table/tbody/tr[6]/td[1]"));;

		assertEquals(Strings.priorityLow, displayedPriority.getText());
