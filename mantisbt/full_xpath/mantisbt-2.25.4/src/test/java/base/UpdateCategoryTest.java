...
public class UpdateCategoryTest extends BaseTest {
	...
	public void updateCategory() throws InterruptedException {
		...
		projectLink.click();
		WebElement editCategory = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[4]/div[2]/div/div[3]/div/div/table/tbody/tr[1]/td[3]/div/div[1]/form/button"));
		editCategory.click();
		Thread.sleep(2000);
		WebElement catNameField = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div[2]/form/div/div[2]/div/div/table/tbody/tr[1]/td[2]/input"));
		catNameField.clear();
		catNameField.sendKeys(category);
		WebElement saveBtn = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div[2]/form/div/div[3]/input"));
		saveBtn.click();
		Thread.sleep(1000);
		WebElement displayedCategory = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[4]/div[2]/div/div[3]/div/div/table/tbody/tr[1]/td[1]"));
