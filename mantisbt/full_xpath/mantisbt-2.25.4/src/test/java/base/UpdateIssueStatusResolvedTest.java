...
public class UpdateIssueStatusResolvedTest extends BaseTest {
	...
	@Test
	public void updateIssueStatusResolved() throws InterruptedException {
		...
		new Select(selectStatus).selectByVisibleText(Strings.statusResolved);
		...
		assertEquals(Strings.statusResolved, displayedStatus.getText());
