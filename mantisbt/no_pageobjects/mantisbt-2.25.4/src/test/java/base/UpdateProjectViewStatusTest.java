...
public class UpdateProjectViewStatusTest extends BaseTest {
	...
	public void updateProjectViewStatus() {
		...
		new Select(driver.findElement(By.id("project-view-state"))).selectByVisibleText(Strings.visibilityPrivate);
		driver.findElement(By.xpath("//*[@id=\"manage-proj-update-form\"]/div/div[3]/input")).click();
		
		assertEquals(Strings.visibilityPrivate, driver.findElement(By.xpath("//*[@id=\"main-container\"]/div[2]/div[2]/div/div/div[2]/div[2]/div/div[2]/table/tbody/tr/td[4]")).getText());
