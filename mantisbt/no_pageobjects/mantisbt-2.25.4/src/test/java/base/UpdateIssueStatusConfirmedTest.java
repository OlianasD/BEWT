...
public class UpdateIssueStatusConfirmedTest extends BaseTest {
	...
	public void updateIssueStatusConfirmed() {
		...
		new Select(driver.findElement(By.id("status"))).selectByVisibleText(Strings.statusConfirmed);
		driver.findElement(By.xpath("//*[@id=\"update_bug_form\"]/div/div[3]/input")).click();
		
		assertEquals(Strings.statusConfirmed, driver.findElement(By.xpath("//*[@id=\"main-container\"]/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/table/tbody/tr[7]/td[1]")).getText());
