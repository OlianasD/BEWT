...
public class UpdateIssueStatusResolvedTest extends BaseTest {
	...
	public void updateIssueStatusResolved() {
		...
		new Select(driver.findElement(By.id("status"))).selectByVisibleText(Strings.statusResolved);
		driver.findElement(By.xpath("//*[@id=\"update_bug_form\"]/div/div[3]/input")).click();
		
		assertEquals(Strings.statusResolved, driver.findElement(By.xpath("//*[@id=\"main-container\"]/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/table/tbody/tr[7]/td[1]")).getText());
