...
public class ChangePassword_OKTest extends BaseTest {
	...
	public void changePassword_OK() throws InterruptedException {
		...
		newPsw.sendKeys("Newe2eW3Bt3s71nGB3nchM4rK");
		WebElement confirmPsw = driver.findElement(By.xpath("/html/body/div[3]/div[3]/div[4]/div[1]/form/div[2]/div/div/div/input"));
		confirmPsw.sendKeys("Newe2eW3Bt3s71nGB3nchM4rK");
		WebElement changeCredBtn = driver.findElement(By.xpath("/html/body/div[3]/div[3]/div[4]/div[1]/form/div[4]/span[1]/button"));
		changeCredBtn.click();
		Thread.sleep(1000);
		WebElement successMsg = driver.findElement(By.xpath("/html/body/div[3]/div[3]/div[4]/div[1]"));

		assertEquals("Your credentials have been changed.", successMsg.getText());
