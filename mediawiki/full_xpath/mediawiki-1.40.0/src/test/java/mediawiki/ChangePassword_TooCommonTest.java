...
public class ChangePassword_TooCommonTest extends BaseTest {
	...
	public void changePassword_TooCommon() throws InterruptedException {
		...
		assertEquals("The password entered is in a list of very commonly used passwords. Please choose a more unique password.", errorMsg.getText());
	}
