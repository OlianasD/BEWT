...
public class AssignUserToGroupTest extends BaseTest {
	...
	public void assignUserToGroup() {
		...
		usersLink.click();
		WebElement secondUserLink = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[2]/th/div[1]/a"));
		new JavascriptExecutor(driver).scrollTo(secondUserLink);
		secondUserLink.click();
		WebElement assignedGroups = driver.findElement(By.xpath("/html/body/div[1]/div/section/div/div/main/form/div/joomla-tab/div/button[2]"));
		assignedGroups.click();
		WebElement groupCheckbox = driver.findElement(By.xpath("/html/body/div[1]/div/section/div/div/main/form/div/joomla-tab/joomla-tab-element[2]/fieldset/div/div[10]/div/label/input"));
		groupCheckbox.click();
		...
		WebElement displayedGroups = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[2]/td[5]"));
		assertTrue(displayedGroups.getText().contains(group));
