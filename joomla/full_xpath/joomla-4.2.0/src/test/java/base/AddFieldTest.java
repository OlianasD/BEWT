...
public class AddFieldTest extends BaseTest {
	...
	public void addField() throws InterruptedException {
		...
		fieldsLink.click();
		WebElement addFieldBtn = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/nav/div/joomla-toolbar-button[1]/button"));
		addFieldBtn.click();
		...
		Thread.sleep(1000);
		WebElement displayedField = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr/th/div/a"));
		assertEquals(field, displayedField.getText());
