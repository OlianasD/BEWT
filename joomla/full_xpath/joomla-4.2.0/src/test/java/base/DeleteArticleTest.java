...
public class DeleteArticleTest extends BaseTest {
	...
	public void deleteArticle() throws Exception {
		...
		articles.click();
		WebElement firstArticleCheckbox = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[1]/td[1]/input"));
		firstArticleCheckbox.click();
		...
		WebElement trash = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/nav/div/joomla-toolbar-button[2]/div/joomla-toolbar-button[7]/button"));
		trash.click();
		Thread.sleep(500);
		WebElement successMsg = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/div/joomla-alert/div[2]/div"));
		WebElement articleList = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table"));
		assertEquals(expectedAlert, successMsg.getText());
		assertFalse(articleList.getText().contains(title));
