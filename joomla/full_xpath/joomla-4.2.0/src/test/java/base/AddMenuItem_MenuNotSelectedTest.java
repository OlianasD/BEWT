...
public class AddMenuItem_MenuNotSelectedTest extends BaseTest {
	...
	public void addMenuItem_MenuNotSelectedNoPO() throws InterruptedException {
		...
		WebElement menuItemTypeSelectBtn = driver.findElement(By.xpath("/html/body/div[1]/div/section/div/div/main/form/div[2]/joomla-tab/joomla-tab-element[1]/div/div[1]/div[1]/div[2]/span/button"));
		menuItemTypeSelectBtn.click();
		Thread.sleep(1000);
		WebElement iframe = driver.findElement(By.xpath("/html/body/div[1]/div/section/div/div/main/form/div[2]/joomla-tab/joomla-tab-element[1]/div/div[1]/div[1]/div[2]/div/div/div/div[2]/iframe"));
		driver.switchTo().frame(iframe);
		//the XPaths refers to the inside of the iframe, not to the main page
		WebElement articlesItemType = driver.findElement(By.xpath("/html/body/div[2]/div[1]/h2/button"));
		articlesItemType.click();
		WebElement archivedArticles = driver.findElement(By.xpath("/html/body/div[2]/div[1]/div/div/div/a[1]/div"));
		archivedArticles.click();
		...
		WebElement errorMsg = driver.findElement(By.xpath("/html/body/div[1]/div/section/div/div/main/form/div[2]/joomla-tab/joomla-tab-element[1]/div/div[2]/fieldset/div[1]/div[1]/label/span[2]"));
		assertEquals("One of the options must be selected", errorMsg.getText());
	}
}
