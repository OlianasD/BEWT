...
public class AddCategoryTest extends BaseTest {
	...
	public void addCategory() {
		...
		WebElement categoryList = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table"));
		assertTrue(categoryList.getText().contains(title));
