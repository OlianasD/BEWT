...
public class AddMenuItemTest extends BaseTest {
	...
	public void addMenuItem() throws InterruptedException {
		...
		WebElement menuItemList = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table"));
		assertEquals("Menu item saved.", successMsg.getText());
		assertTrue(menuItemList.getText().contains(name));
	}
}
