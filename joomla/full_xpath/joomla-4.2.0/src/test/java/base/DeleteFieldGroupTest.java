...
public class DeleteFieldGroupTest extends BaseTest {
	
	@Test
	public void deleteFieldGroup() throws InterruptedException {
		...
		WebElement firstGroupCheckbox = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[1]/td[1]/input"));
		firstGroupCheckbox.click();
		WebElement actionsBtn = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/nav/div/joomla-toolbar-button[2]/button"));
		actionsBtn.click();
		WebElement trashBtn = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/nav/div/joomla-toolbar-button[2]/div/joomla-toolbar-button[5]/button"));
		trashBtn.click();
		Thread.sleep(1000);
		WebElement emptyTableText = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/div[2]"));

		assertTrue(emptyTableText.getText().contains("No Matching Results"));
