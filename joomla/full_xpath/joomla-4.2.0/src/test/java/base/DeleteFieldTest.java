...
public class DeleteFieldTest extends BaseTest {
	...
	public void deleteField() throws InterruptedException {
		...
		fieldsLink.click();
		WebElement testFieldCheckbox = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[1]/td[1]/input"));
		testFieldCheckbox.click();
