...
public class DeleteUserTest extends BaseTest {
	...
	public void deleteUser() throws InterruptedException {
		...
		usersLink.click();
		WebElement secondUserCheckbox = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table/tbody/tr[2]/td[1]/input"));
		secondUserCheckbox.click();
		...
		actionsBtn.click();
		WebElement deleteBtn = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/nav/div/joomla-toolbar-button[2]/div/joomla-toolbar-button[5]/button"));
		deleteBtn.click();
		...
		WebElement userList = driver.findElement(By.xpath("/html/body/div[1]/div[2]/section/div/div/main/form/div/div/div/table"));

		assertEquals(expectedAlert, successMsg.getText());
		assertFalse(userList.getText().contains(user));
